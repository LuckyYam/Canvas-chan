...
export class Simp {
    ...
    public build = async (): Promise<Buffer> => {
        ...
        if (typeof this.image !== 'string' && !Buffer.isBuffer(this.image)) throw new TypeError(`The image should be of type string or instance of Buffer. Recieved ${typeof this.image}`)
